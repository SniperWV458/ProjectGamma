...
CONTRACT_PATH = Path(r"E:\Pythonfiles\ProjectGamma\results\option_gamma\contract_gex.parquet")
OUTPUT_PATH = Path(r"E:\Pythonfiles\ProjectGamma\data\gex_contract_factors.parquet")
